        ...
        >
          ...
          >
            ...
            <div className="shrink-0 z-10 flex items-center justify-between border-b border-primary-100 bg-white px-5 py-4 rounded-t-2xl">
              ...
              <button
                onClick={onClose}
                className="flex items-center justify-center rounded-full min-w-11 min-h-11 text-primary-400 transition-[colors,transform] duration-150 hover:bg-primary-50 hover:text-primary-400 active:scale-[0.93] cursor-pointer"
