  ...
  return (
    <div className="min-h-dvh flex flex-col bg-primary-50/60 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
        ...
        <div className="absolute -bottom-24 -left-24 w-64 h-64 rounded-full bg-primary-300/15 blur-[60px]" />
        <div className="absolute top-40 right-10 text-primary-200/20 hidden sm:block">
          <Leaf size={48} strokeWidth={1} style={{ transform: 'rotate(35deg)' }} />
        </div>
      </div>
      ...
      <div className="relative flex-1 flex flex-col w-full max-w-[440px] mx-auto">
        ...
        >
          ...
          {/* Hero */}
          <motion.div {...motionProps} className="px-6 pt-8 pb-1">
