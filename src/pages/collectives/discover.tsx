        ...
        <div className="relative min-h-full overflow-x-hidden">
          ...
          <motion.div
            ...
            animate={
              rm
                ? undefined
                : { y: [0, 16, 0], scale: [1, 1.1, 1], opacity: [0.2, 0.35, 0.2] }
            }
          ...
          {/* ── Floating dots ── */}
          <motion.div
            className="absolute top-28 right-14 w-2.5 h-2.5 rounded-full bg-secondary-300/25"
            animate={rm ? undefined : { y: [0, -10, 0], opacity: [0.25, 0.5, 0.25] }}
            transition={{ duration: 4, repeat: Infinity, ease: 'easeInOut' }}
          />
          <motion.div
            className="absolute top-56 left-8 w-2 h-2 rounded-full bg-moss-300/20"
            animate={rm ? undefined : { y: [0, 8, 0], opacity: [0.2, 0.45, 0.2] }}
            transition={{ duration: 5.5, repeat: Infinity, ease: 'easeInOut', delay: 1.2 }}
          />
          <motion.div
            className="absolute top-[24rem] right-24 w-3 h-3 rounded-full bg-secondary-300/25"
            animate={rm ? undefined : { y: [0, -12, 0], opacity: [0.25, 0.5, 0.25] }}
            transition={{ duration: 6, repeat: Infinity, ease: 'easeInOut', delay: 2 }}
          />
          <motion.div
            className="absolute top-[36rem] left-12 w-2 h-2 rounded-full bg-moss-300/20"
