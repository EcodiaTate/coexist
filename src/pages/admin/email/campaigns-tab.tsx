...
function CampaignComposer({
  ...
  return (
    <div className="space-y-5">
      ...
      {step === 'compose' && (
        <div className="space-y-4">
          ...
          {templateVars.length > 0 && (
            <div className="rounded-sm bg-white border border-neutral-100 shadow-sm p-4 space-y-3">
      ...
      {step === 'audience' && (
        <div className="space-y-4">
          <div className="rounded-sm bg-white shadow-sm border border-neutral-100 p-4">
            <Toggle
              checked={targetAll}
      ...
      {step === 'preview' && (
        <div className="space-y-4">
          <div className="rounded-sm bg-white shadow-sm border border-neutral-100 overflow-hidden">
          ...
          {templateVars.length > 0 && templateVars.some((v) => !fieldValues[v]) && (
            <div className="rounded-sm bg-warning-50 border border-warning-200 p-3">
        ...
        {campaign.status === 'sent' && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
            {[
              ...
              <div key={label} className="rounded-sm bg-neutral-50 p-3">
              ...
              <div className="flex items-start justify-between gap-3" onClick={() => setViewing(campaign)}>
                ...
                <div className="flex items-center gap-1 shrink-0" onClick={(e) => e.stopPropagation()}>
                  {campaign.status === 'draft' && (
                    <button onClick={() => setEditing(campaign)} className="flex items-center justify-center min-w-11 min-h-11 rounded-sm text-neutral-400 hover:bg-neutral-50 hover:text-neutral-600 transition-[colors,transform] duration-150 cursor-pointer active:scale-[0.98]" aria-label="Edit">
                      <Edit3 size={14} />
                    </button>
                  )}
                  <button onClick={() => duplicateCampaign(campaign)} className="flex items-center justify-center min-w-11 min-h-11 rounded-sm text-neutral-400 hover:bg-neutral-50 hover:text-neutral-600 transition-[colors,transform] duration-150 cursor-pointer active:scale-[0.98]" aria-label="Duplicate">
                    <Copy size={14} />
                  </button>
                  <button onClick={() => setDeletingId(campaign.id)} className="flex items-center justify-center min-w-11 min-h-11 rounded-sm text-neutral-400 hover:bg-error-100 hover:text-error-600 transition-[colors,transform] duration-150 cursor-pointer active:scale-[0.98]" aria-label="Delete">
                    <Trash2 size={14} />
                  </button>
                </div>
              </div>
