-- ============================================================================
-- Exclude legacy import rows from impact aggregation RPCs
--
-- Legacy rows (bulk-imported historical data) are identified by
-- notes LIKE 'Legacy import:%'. They have been replaced by baseline
-- constants in app_settings. The RPCs must exclude them so they
-- don't double-count against the seeded baseline.
-- ============================================================================
