...
INSERT INTO badges (id, name, description, icon_url, category, criteria, points_value, tier) VALUES
  -- Attendance badges
  ('b0000000-0000-0000-0000-000000000001', 'First Steps', 'Attend your first event', '/icons/badge-first-steps.svg', 'attendance', '{"events_attended": 1}', 50, 'bronze'),
  ('b0000000-0000-0000-0000-000000000002', 'Getting Started', 'Attend 5 events', '/icons/badge-getting-started.svg', 'attendance', '{"events_attended": 5}', 100, 'bronze'),
  ('b0000000-0000-0000-0000-000000000003', 'Regular', 'Attend 10 events', '/icons/badge-regular.svg', 'attendance', '{"events_attended": 10}', 200, 'silver'),
  ('b0000000-0000-0000-0000-000000000004', 'Dedicated', 'Attend 25 events', '/icons/badge-dedicated.svg', 'attendance', '{"events_attended": 25}', 500, 'silver'),
  ('b0000000-0000-0000-0000-000000000005', 'Veteran', 'Attend 50 events', '/icons/badge-veteran.svg', 'attendance', '{"events_attended": 50}', 1000, 'gold'),
  ('b0000000-0000-0000-0000-000000000006', 'Legend', 'Attend 100 events', '/icons/badge-legend.svg', 'attendance', '{"events_attended": 100}', 2000, 'gold'),

  -- Activity-specific badges
  ('b0000000-0000-0000-0000-000000000010', 'Tree Hugger', 'Attend 5 tree planting events', '/icons/badge-tree-hugger.svg', 'activity', '{"activity_type": "tree_planting", "count": 5}', 150, 'bronze'),
  ('b0000000-0000-0000-0000-000000000011', 'Forest Maker', 'Attend 20 tree planting events', '/icons/badge-forest-maker.svg', 'activity', '{"activity_type": "tree_planting", "count": 20}', 500, 'gold'),
  ('b0000000-0000-0000-0000-000000000012', 'Shore Keeper', 'Attend 5 beach cleanup events', '/icons/badge-shore-keeper.svg', 'activity', '{"activity_type": "beach_cleanup", "count": 5}', 150, 'bronze'),
  ('b0000000-0000-0000-0000-000000000013', 'Ocean Guardian', 'Attend 20 beach cleanup events', '/icons/badge-ocean-guardian.svg', 'activity', '{"activity_type": "beach_cleanup", "count": 20}', 500, 'gold'),
  ('b0000000-0000-0000-0000-000000000014', 'Habitat Hero', 'Attend 5 habitat restoration events', '/icons/badge-habitat-hero.svg', 'activity', '{"activity_type": "habitat_restoration", "count": 5}', 150, 'bronze'),
  ('b0000000-0000-0000-0000-000000000015', 'Nature Scout', 'Attend 5 nature walk events', '/icons/badge-nature-scout.svg', 'activity', '{"activity_type": "nature_walk", "count": 5}', 150, 'bronze'),
  ('b0000000-0000-0000-0000-000000000016', 'Seed Saver', 'Attend 5 seed collecting events', '/icons/badge-seed-saver.svg', 'activity', '{"activity_type": "seed_collecting", "count": 5}', 150, 'bronze'),
  ('b0000000-0000-0000-0000-000000000017', 'Weed Warrior', 'Attend 5 weed removal events', '/icons/badge-weed-warrior.svg', 'activity', '{"activity_type": "weed_removal", "count": 5}', 150, 'bronze'),
  ('b0000000-0000-0000-0000-000000000018', 'Water Watcher', 'Attend 5 waterway cleanup events', '/icons/badge-water-watcher.svg', 'activity', '{"activity_type": "waterway_cleanup", "count": 5}', 150, 'bronze'),
  ('b0000000-0000-0000-0000-000000000019', 'Wildlife Whisperer', 'Attend 5 wildlife survey events', '/icons/badge-wildlife-whisperer.svg', 'activity', '{"activity_type": "wildlife_survey", "count": 5}', 150, 'bronze'),

  -- Social badges
  ('b0000000-0000-0000-0000-000000000020', 'Social Butterfly', 'Post 10 times in the community feed', '/icons/badge-social.svg', 'social', '{"posts_created": 10}', 100, 'bronze'),
  ('b0000000-0000-0000-0000-000000000021', 'Recruiter', 'Refer 3 friends who join', '/icons/badge-recruiter.svg', 'social', '{"referrals": 3}', 200, 'silver'),
  ('b0000000-0000-0000-0000-000000000022', 'Storyteller', 'Share 20 photos from events', '/icons/badge-storyteller.svg', 'social', '{"photos_shared": 20}', 150, 'silver'),

  -- Impact badges
  ('b0000000-0000-0000-0000-000000000030', 'Green Thumb', 'Help plant 100 native plants', '/icons/badge-green-thumb.svg', 'impact', '{"trees_planted": 100}', 300, 'silver'),
  ('b0000000-0000-0000-0000-000000000031', 'Clean Machine', 'Help collect 50 kg of rubbish', '/icons/badge-clean-machine.svg', 'impact', '{"rubbish_kg": 50}', 300, 'silver'),
  ('b0000000-0000-0000-0000-000000000032', 'Time Giver', 'Volunteer 100 hours', '/icons/badge-time-giver.svg', 'impact', '{"hours_volunteered": 100}', 500, 'gold'),

  -- Tier badges
  ('b0000000-0000-0000-0000-000000000040', 'Seedling', 'Welcome to Co-Exist!', '/icons/badge-seedling.svg', 'tier', '{"tier": "Seedling"}', 0, 'bronze'),
  ('b0000000-0000-0000-0000-000000000041', 'Sapling', 'Reached Sapling tier', '/icons/badge-sapling.svg', 'tier', '{"tier": "Sapling"}', 0, 'bronze'),
  ('b0000000-0000-0000-0000-000000000042', 'Native', 'Reached Native tier', '/icons/badge-native.svg', 'tier', '{"tier": "Native"}', 0, 'silver'),
  ('b0000000-0000-0000-0000-000000000043', 'Canopy', 'Reached Canopy tier', '/icons/badge-canopy.svg', 'tier', '{"tier": "Canopy"}', 0, 'gold'),
  ('b0000000-0000-0000-0000-000000000044', 'Elder', 'Reached Elder tier', '/icons/badge-elder.svg', 'tier', '{"tier": "Elder"}', 0, 'gold')
